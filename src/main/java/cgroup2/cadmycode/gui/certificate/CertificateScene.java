...
public class CertificateScene extends SceneWrapper {
    ...
    private TableColumn<Module, Integer> certificateID = new TableColumn<>("certificateID");
    private TableColumn<Module, String> certificateName = new TableColumn<>("certificateName");
